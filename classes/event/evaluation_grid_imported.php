 ...
 * Evaluation grid imported
 *
 * Message sent /created when an evaluation grid has been imported
 *
 * @package   local_cveteval
 * @copyright 2021 - CALL Learning - Laurent David <laurent@call-learning.fr>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class evaluation_grid_imported extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('evaluationgridimported', 'local_cveteval');
    }
