...
class situations extends \external_api {
     ...
     */
    public static function get_user_situations_parameters() {
     ...
     */
    public static function get_user_situations_returns() {
     ...
     */
    public static function get_user_situations($userid) {
        global $DB;
