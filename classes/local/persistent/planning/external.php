...
class external extends external_api {
    ...
    public static function create_planning($planning) {
        global $PAGE;
        $inputparams = compact($planning);
        $params = self::validate_parameters(self::create_planning_parameters(), $inputparams);
        $planning = $params['planning'];
        $planning = new entity(0, $planning);
        $planning->save();
    ...
    public static function create_planning_returns() {
        return new external_single_structure(
            ['planning' => exporter::get_read_structure()]
        );
    }
}