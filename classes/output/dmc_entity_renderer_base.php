...
abstract class dmc_entity_renderer_base implements renderable, \templatable {
    protected data_migration_controller $dmc;
    ...
    public function export_entity_group_assignment($entityid) {
    ...
    public function export_entity_planning($entityid) {
    ...
    public function export_entity_role($entityid) {
