...
$string['evaluation_grid:idnumber'] = 'Evaluation Grid identifier';
$string['evaluation_grid:name'] = 'Evaluation Grid name';
...
$string['group_assignment:group'] = 'Group';
$string['group_assignment:student'] = 'Student';
...
$string['pluginname'] = 'CompetVetEval plugin';
$string['role:entity'] = 'Role';
$string['role:userid'] = 'User';
$string['role:clsituationid'] = 'Situation';
$string['role:type'] = 'Type of role';
