...
class data_migration_test extends \advanced_testcase {
    ...
    public function test_migration() {
        ...
        $EXPECTED_CONVERTED_APPRAISALS_STUDENT_2 = [
        ...
        $EXPECTED_CONVERTED_APPRAISALS_STUDENT_1 = [
        ...
        $this->assertEquals((object) $EXPECTED_CONVERTED_APPRAISALS_STUDENT_2, $convertedappraisalsinfo[0]);
        $this->assertEquals((object) $EXPECTED_CONVERTED_APPRAISALS_STUDENT_1, $convertedappraisalsinfo[1]);
    }
}
